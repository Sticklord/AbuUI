...
local function updateRaidFrameLayout(self, width, height)
	...
	do
		local incHeals = self.HealthPrediction.incHeals
		local necroHeals = self.HealthPrediction.necroHeals
		local absorb = self.HealthPrediction.TotalAbsorb
...
local function createRaidFrame(self, unit)
	...
	self.HealthPrediction = {
		...
		TotalAbsorb = absorb,
		Override = ns.HealthPrediction_UpdateOverride,
	}
